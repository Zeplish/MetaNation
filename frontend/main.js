Moralis.initialize("MRVpbOLcX0xnUxbTEwTpPp89CVND1wYz5sCpjc1h");
Moralis.serverURL = "https://4kmjeixtwkna.usemoralis.com:2053/server"
...
mintNft = async (metadataUrl) => {
    // let user = Moralis.User.current();
    // let userAddress = user.get("ethAddress");
    const receipt = await tokenContract.methods.createItem(metadataUrl).send({from: ethereum.selectedAddress, to: TOKEN_CONTRACT_ADDRESS});
    console.log(receipt);
